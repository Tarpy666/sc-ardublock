...
**Fleet designation:** `sc-ardublock` · Part of the Counted fleet.

## Abstract

Arduino block kernel: pin blocks, C++ codegen, serial bridge. This repository ships a self-contained, deterministic implementation:
