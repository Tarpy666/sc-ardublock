...
Arduino block kernel: pin blocks, C++ codegen, serial bridge.

Part of the Counted fleet (sc-ardublock), stack class `backend`, generated
from `seeds/seeds.yaml`.

## Architecture (docs/REPO_STANDARD.md)

- `src/lib/modules.ts` — module registry: PinBlocks, CppCodegen, SerialBridge
